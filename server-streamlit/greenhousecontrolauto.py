...
while True:
    ...
    utctime: str = dtt.now(tz=utc).strftime("%Y-%m-%d %H:%M:%S")

    currenttime: dtt = dtt.now()
    ...
    if greenhouse_humidity > fan_on_humidity_val:
        if fan_relay_state[-1] == "1":
            ...
            publish_relay_status(device_id="001", relay_id="2", action_id="011")
            data = {
                "actiontime": utctime,
                "deviceid": "001",
                "relayid": "2",
        ...
        if fan_relay_state[-1] == "0":
            ...
            publish_relay_status(device_id="001", relay_id="2", action_id="010")
            data = {
                "actiontime": utctime,
                "deviceid": "001",
                "relayid": "2",
    ...
    if (
        ...
        if water_relay_state[-1] == "1":
            ...
            publish_relay_status(device_id="001", relay_id="1", action_id="011")
            data = {
                "actiontime": utctime,
                "deviceid": "001",
                "relayid": "1",
        ...
        if water_relay_state[-1] == "0":
            ...
            publish_relay_status(device_id="001", relay_id="1", action_id="010")
            data = {
                "actiontime": utctime,
                "deviceid": "001",
                "relayid": "1",
    ...
    #         pass
    #     else:
    #         publish_relay_status(device_id="001", relay_id="4", action_id="011")
    #         data = {
    #             "actiontime": utctime,
    #             "deviceid": "001",
    #             "relayid": "4",
    ...
    #         pass
    #     else:
    #         publish_relay_status(device_id="001", relay_id="4", action_id="010")
    #         data = {
    #             "actiontime": utctime,
    #             "deviceid": "001",
    #             "relayid": "4",
